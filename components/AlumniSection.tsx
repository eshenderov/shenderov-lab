...
const AlumniSection = () => {
  return (
    <section id="team">
      <h2 className="bg-gradient-to-r from-dragonfruit to-peach bg-clip-text pb-12 text-center font-sans text-5xl sm:text-6xl font-black text-transparent lg:pb-24">
        Lab Alumni Family
      </h2>
