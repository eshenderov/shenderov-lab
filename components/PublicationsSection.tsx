  ...
  const res = await axios.get<GetSearchResponse>(
    "https://eutils.ncbi.nlm.nih.gov/entrez/eutils/esearch.fcgi",
    {
      params: {
        ...
        retmode: "json",
        api_key: "288280414e54e83d2b7b07c117fd414a7008",
      },
    }
  );
...
const PublicationsSection = () => {
  ...
  return (
    <section id="publications">
      ...
      <div className="flex h-[44rem] flex-col justify-between gap-4 rounded-2xl bg-raisin-bright p-8 text-white sm:gap-6 sm:p-12">
