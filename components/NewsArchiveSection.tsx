import NewsArchiveBlock from "./NewsArchiveBlock";

const NewsArchiveSection = () => {
  return (
    <section id="news archive">
      ...
      <div className="grid gap-12 lg:grid-cols-2 2xl:grid-cols-3">
        ...
        <NewsArchiveBlock headline="Dr. Ling Huang Matches to Oncology Fellowship" date="November 30, 2022">
...
export default NewsArchiveSection;