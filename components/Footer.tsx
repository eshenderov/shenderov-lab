  ...
  return (
    <footer className="flex w-full flex-col items-center justify-between gap-8 py-8 px-12 text-center text-white sm:py-16 sm:px-32 xl:px-48">
      <div className="flex items-center gap-8">
        <a
          href="https://www.linkedin.com/in/eugene-shenderov-m-d-d-phil-facp-46384a7b/"
          target="_blank"
          rel="noreferrer"
        >
        ...
        <a
          href="https://twitter.com/doceshenderov"
          target="_blank"
          rel="noreferrer"
        >
        ...
        <a
          href="https://www.hopkinsmedicine.org/profiles/details/eugene-shenderov"
          target="_blank"
          rel="noreferrer"
        >
        ...
        <a
          href="https://scholar.google.com/citations?user=YarQeqEAAAAJ&hl=en"
          target="_blank"
          rel="noreferrer"
        >
